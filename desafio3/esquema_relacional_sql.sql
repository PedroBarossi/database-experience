...
create table orders(
    ...
    constraint fk_order_payment foreign key (idOpayment) references payments(idPayment)
);
...
-- criar relação produtos->vendedor
...
-- criar relação produtos->estoque
...
-- criar relação produto->fornecedor
create table productSupplier(
	idPsSupplier int,
    idPsProduct int,
    quantity int not null,
    primary key (idPsSupplier, idPsProduct),
    constraint fk_supplier_supplier foreign key (idPsSupplier) references supplier(idSupplier),
